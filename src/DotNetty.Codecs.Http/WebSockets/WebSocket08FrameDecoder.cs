            ...
            switch (this.state)
            {
                ...
                case State.ReadingSecond:
                    ...
                    if (this.frameOpcode > 7)
                    {
                        ...
                        if (!(this.frameOpcode == OpcodeClose || this.frameOpcode == OpcodePing
                ...
                case State.Payload:
                    ...
                    try
                    {
                        ...
                        {
                            throw new NotSupportedException($"Cannot decode web socket frame with opcode: {this.frameOpcode}");
                        }
                    }
                    finally
                    {
