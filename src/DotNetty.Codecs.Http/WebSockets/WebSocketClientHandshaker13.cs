...
namespace DotNetty.Codecs.Http.WebSockets
{
    ...
    public class WebSocketClientHandshaker13 : WebSocketClientHandshaker
    {
        ...
        protected override IWebSocketFrameDecoder NewWebsocketDecoder() =>
            new WebSocket13FrameDecoder(false, this.allowExtensions, this.MaxFramePayloadLength, this.allowMaskMismatch);

        protected override IWebSocketFrameEncoder NewWebSocketEncoder() =>
            new WebSocket13FrameEncoder(this.performMasking);
    }
}
