...
namespace DotNetty.Codecs.Http.WebSockets
{
    ...
    public class WebSocketClientHandshaker08 : WebSocketClientHandshaker
    {
        ...
        protected override IWebSocketFrameDecoder NewWebsocketDecoder() =>
            new WebSocket08FrameDecoder(false, this.allowExtensions, this.MaxFramePayloadLength, this.allowMaskMismatch);

        protected override IWebSocketFrameEncoder NewWebSocketEncoder() =>
            new WebSocket08FrameEncoder(this.performMasking);
    }
}
