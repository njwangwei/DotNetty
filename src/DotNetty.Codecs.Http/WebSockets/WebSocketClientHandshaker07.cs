...
namespace DotNetty.Codecs.Http.WebSockets
{
    ...
    public class WebSocketClientHandshaker07 : WebSocketClientHandshaker
    {
        ...
        protected override IWebSocketFrameDecoder NewWebsocketDecoder() =>
            new WebSocket07FrameDecoder(false, this.allowExtensions, this.MaxFramePayloadLength, this.allowMaskMismatch);

        protected override IWebSocketFrameEncoder NewWebSocketEncoder() => 
            new WebSocket07FrameEncoder(this.performMasking);
    }
}
